...
import {
  EuforiaCafeSummarySection,
  EuforiaCafeServiceSection,
  EuforiaCafeInvoiceSection,
  EuforiaCafeCredentialsSection,
  EuforiaCafeConfigurationSection,
  EuforiaCafeDatesSection,
  EuforiaCafeTermsSection,
} from "@/components/proposals/euforia-cafe-content"
...
export default function EuforiaCafeProposalPage() {
  return (
    <Suspense>
      <EuforiaCafeProposalPageInner />
    </Suspense>
  )
}

const SIGNATURE_STORAGE_KEY = "proposal-euforia-cafe-signature"

function EuforiaCafeProposalPageInner() {
  ...
  const signatureHolderName = "Cliente Euforia Café"
        ...
        <div className="rounded-lg bg-white p-8 shadow-lg print:shadow-none" style={{ backgroundColor: 'white' }}>
          <div className="mb-8 border-b border-gray-200 pb-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-gray-600">Correo Corporativo - Euforia Café</p>
              </div>
          ...
          <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700">Euforia Café</p>
              <p className="text-sm text-gray-600">euforiacafe.com</p>
            </div>
          </div>
