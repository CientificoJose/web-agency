...
export default function EuforiaCafeProposalPage2() {
  return (
    <Suspense>
      <EuforiaCafeProposalPage2Inner />
    </Suspense>
  )
}

const SIGNATURE_STORAGE_KEY = "proposal-euforia-cafe-2-signature"

function EuforiaCafeProposalPage2Inner() {
