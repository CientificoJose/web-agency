...
import {
  JgStoreDeliverablesSection,
  JgStorePlansSection,
  JgStoreProcessSection,
  JgStoreScopeSection,
  JgStoreSummarySection,
  JgStoreTermsSection,
} from "@/components/proposals/jg-store-modernizacion-content"
...
export default function JgStoreModernizacionProposalPage() {
  return (
    <Suspense>
      <JgStoreModernizacionProposalPageInner />
    </Suspense>
  )
}

const SIGNATURE_STORAGE_KEY = "proposal-jg-store-modernizacion-signature"

function JgStoreModernizacionProposalPageInner() {
    ...
    <div className="bg-gray-100 flex justify-center items-start md:items-center p-0 md:p-4 print:p-0 font-sans min-h-screen">
      ...
      <div className="a4-container w-full md:w-[210mm] md:min-h-[297mm] bg-white md:shadow-xl relative overflow-hidden p-4 sm:p-6 md:p-[25mm] print:shadow-none print:p-[25mm]">
        ...
        <div className="text-center pb-5 border-b-2 border-primary mb-6 md:mb-8 w-full">
          ...
          <h2 className="text-base md:text-lg text-primary">Propuesta de Modernización TiendaNube + Landing MercadoLibre</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5 mb-6 md:mb-8">
          ...
          <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-primary">
            ...
            <p className="text-gray-700 text-sm md:text-base">JG Store</p>
            <p className="text-gray-700 text-sm md:text-base">Fecha: 31/12/2025</p>
          </div>
        </div>
