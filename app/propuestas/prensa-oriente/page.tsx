...
import {
  PrensaOrienteSummarySection,
  PrensaOrienteBillingHistorySection,
  PrensaOrienteUpcomingChargesSection,
  PrensaOrienteBankDetailsSection,
  PrensaOrienteTermsSection,
} from "@/components/proposals/prensa-oriente-content"
...
export default function PrensaOrienteProposalPage() {
  return (
    <Suspense>
      <PrensaOrienteProposalPageInner />
    </Suspense>
  )
}

const SIGNATURE_STORAGE_KEY = "proposal-prensa-oriente-signature"

function PrensaOrienteProposalPageInner() {
  ...
  const handleSave = () => {
    ...
    try {
      ...
      window.localStorage.setItem(SIGNATURE_STORAGE_KEY, JSON.stringify(signatureData))
  ...
  const signatureHolderName = "Cliente Prensa Oriente"
        ...
        <div className="rounded-lg bg-white p-8 shadow-lg print:shadow-none" style={{ backgroundColor: 'white' }}>
          <div className="mb-8 border-b border-gray-200 pb-6">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-gray-900">Estado de Servicio</h1>
                <p className="mt-2 text-sm text-gray-600">Hosting y Dominio - Prensa Oriente</p>
              </div>
          ...
          <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700">Prensa Oriente</p>
              <p className="text-sm text-gray-600">prensaoriente.com.ve</p>
            </div>
          </div>
