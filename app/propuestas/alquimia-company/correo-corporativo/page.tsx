...
import {
  ...
  AlquimiaCompanyTermsSection,
} from "@/components/proposals/alquimia-company-content"
...
export default function AlquimiaCompanyProposalPage() {
  return (
    <Suspense>
      <AlquimiaCompanyProposalPageInner />
    </Suspense>
  )
}

const SIGNATURE_STORAGE_KEY = "proposal-alquimia-company-signature"

function AlquimiaCompanyProposalPageInner() {
  ...
  const signatureHolderName = "Valentina Alvarez"
        ...
        <div className="rounded-lg bg-white p-8 shadow-lg print:shadow-none" style={{ backgroundColor: 'white' }}>
          <div className="mb-8 border-b border-gray-200 pb-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-gray-600">Correo Corporativo - Alquimia Company</p>
              </div>
          ...
          <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div>
              ...
              <p className="text-sm text-gray-700">Valentina Alvarez</p>
              <p className="text-sm text-gray-700">Alquimia Company</p>
              <p className="text-sm text-gray-600">alquimiaCompany.com</p>
            </div>
          </div>
