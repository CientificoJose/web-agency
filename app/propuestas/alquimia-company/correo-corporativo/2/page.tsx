...
export default function AlquimiaCompanyProposalPage2() {
  return (
    <Suspense>
      <AlquimiaCompanyProposalPage2Inner />
    </Suspense>
  )
}

const SIGNATURE_STORAGE_KEY = "proposal-alquimia-company-2-signature"

function AlquimiaCompanyProposalPage2Inner() {
