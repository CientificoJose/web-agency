...
import WebHeader from "@/components/web-informativas/web-header"
import PriceCalculator from "@/components/web-informativas/price-calculator"
import WhatsAppButton from "@/components/whatsapp-button"
import ThemeToggle from "@/components/theme-toggle"
import { useTheme } from "@/hooks/use-theme"

export default function WebInformativasPage() {
      ...
      <main id="main" className="relative z-10" style={{ overflow: "visible" }}>
        <div className="mx-auto max-w-6xl px-4 lg:px-8 space-y-24" style={{ overflow: "visible" }}>
          ...
          <section id="hero" className="text-center space-y-6 pt-24 lg:pt-32" style={{ overflow: "visible" }}>
            ...
            >
              Estima el costo de tu próximo sitio web empresarial o informativo de manera rápida y transparente
            </motion.p>
          </section>
            ...
            <div className="bg-white/5 backdrop-blur-md ring-1 ring-white/10 rounded-3xl p-8 max-w-2xl mx-auto">
              ...
              <motion.button
                ...
                onClick={() => {
                  ...
                  const message = "¡Hola! Me interesa una cotización para mi sitio web informativo."
